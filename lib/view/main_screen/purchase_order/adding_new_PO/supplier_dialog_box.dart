...
class _SupplierDialogBoxState extends State<SupplierDialogBox> {
  ...
  void _onSearchChanged() {
    setState(() {
      _filteredSuppliers = widget.suppliers
          .where((supplier) =>
              supplier.toLowerCase().contains(_searchController.text.toLowerCase()))
          .toList();
    });
  }
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text(
                      '${_filteredSuppliers.length} of ${widget.suppliers.length} supplier${_filteredSuppliers.length != 1 ? 's' : ''} shown',
                      style: TextStyle(
                        color: Colors.grey[600],
                        fontSize: 14,
                      ),
